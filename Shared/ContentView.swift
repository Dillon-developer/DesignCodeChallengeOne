    ...
    var body: some View {
        ZStack {
            ...
            CardView()
                ...
                //.cornerRadius(20) //need smoother corners^^
                .shadow(radius: 20)
                ...
                .animation(.spring(response: 0.55, dampingFraction: 0.6, blendDuration: 0), value: show)
                .animation(.spring(response: 0.55, dampingFraction: 0.6, blendDuration: 0), value: showCard)
...
struct BottomCardView: View {
    ...
    var body: some View {
        VStack(spacing: 20){
            ...
            HStack(spacing: 20.0) {
                RingView(color1: .green, color2: .cyan, color3: .blue, width: 88, height: 88, percent: 80, show: $show)
